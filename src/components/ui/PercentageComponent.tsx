...
export default function PercentageComponent({ compressionPercentage, fileSizeInKB, originalFileInKB }: PercentageComponentProps) {
  return (
    <>
    <p className="text-3xl bg-primary-500 text-neutral-900 flex items-center pl-10">
        ...
        <div className="w-0 h-0 border-t-[40px] border-b-[40px] border-l-[40px] border-transparent border-l-primary-500 border flex flex-row items-center gap-5 relative"></div>
    </>
  )
}
